...
function ZONE:Draw()
	...
	cam.Start3D2D( max, Angle(0,0,0), 1 )
		...
		x = ( b_tonumber(max.x < corners[4].x) * max:Distance(corners[4]) )
		y = ( b_tonumber(max.y > corners[3].y) * max:Distance(corners[3]) )
	...
	cam.Start3D2D( max, Angle(0,0,90), 1 )
		...
		x = ( b_tonumber(max.x < corners[4].x) * max:Distance(corners[4]) )
		y = ( b_tonumber(max.z > corners[2].z) * max:Distance(corners[2]) )
	...
	cam.Start3D2D( max, Angle(90,0,0), 1 )
		...
		x = ( b_tonumber(max.z > corners[2].z) * max:Distance(corners[2]) )
		y = ( b_tonumber(max.y > corners[3].y) * max:Distance(corners[3]) )
	...
	cam.Start3D2D( min, Angle(0,0,0), 1 )
		...
		x = ( b_tonumber(min.x < corners[7].x) * min:Distance(corners[7]) )
		y = ( b_tonumber(min.y > corners[6].y) * min:Distance(corners[6]) )
	...
	cam.Start3D2D( min, Angle(0,0,90), 1 )
		...
		x = ( b_tonumber(min.x < corners[7].x) * min:Distance(corners[7]) )
		y = ( b_tonumber(min.z > corners[5].z) * min:Distance(corners[5]) )
	...
	cam.Start3D2D( min, Angle(90,0,0), 1 )
		...
		x = ( b_tonumber(min.z > corners[5].z) * min:Distance(corners[5]) )
		y = ( b_tonumber(min.y > corners[6].y) * min:Distance(corners[6]) )
